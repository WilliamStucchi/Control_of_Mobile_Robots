#include "unicycle_kin_sim/unicycle_kin_linctrl.h"
...
void unicycle_kin_linctrl::Prepare(void)
{
    ...
    /* ROS topics */
    vehicleState_subscriber = Handle.subscribe("/state", 1, &unicycle_kin_linctrl::vehicleState_MessageCallback, this);
...
void unicycle_kin_linctrl::PeriodicTask(void)
{
    ...
    else if (ros::Time::now().toSec()<=6.0)
    {
        vPx = 4.0;
        vPy = 0.0;
    }
