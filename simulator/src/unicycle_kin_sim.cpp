...
void unicycle_kin_sim::PeriodicTask(void)
{
    ...
    simulator->getActPose(act_x, act_y, act_theta);
    ...
    vehicleStateMsg.data.push_back(act_x);
    vehicleStateMsg.data.push_back(act_y);
    vehicleStateMsg.data.push_back(act_theta);
