...
void unicycle_kin_sim::PeriodicTask(void)
{
    ...
    double linvelocity, angvelocity;
    simulator->getCommands(linvelocity, angvelocity);
    ...
    vehicleStateMsg.data.push_back(linvelocity);
    vehicleStateMsg.data.push_back(angvelocity);
